...
export const PLANS_DATA: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Uitgebreid Kinder- & Familiepakket',
...
export const TRENDING_NL: Film[] = [
  ...
  { title: 'Project Hail Mary', year: 2026, genre: 'Sci-Fi', rating: 8.2, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BNTkwNzJiYTctNzI3NC00NjE1LTlhYjktY2Q5MTdmMWFmNzcxXkEyXkFqcGc@._V1_.jpg' },
  { title: 'The Shawshank Redemption', year: 1994, genre: 'Drama', rating: 9.3, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMDAyY2FhYjctNDc5OS00MDNlLThiMGUtY2UxYWVkNGY2ZjljXkEyXkFqcGc@._V1_.jpg' },
  { title: 'The Godfather', year: 1972, genre: 'Misdaad', rating: 9.2, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BNGEwYjgwOGQtYjg5ZS00Njc1LTk2ZGEtM2QwZWQ2NjdhZTE5XkEyXkFqcGc@._V1_.jpg' },
  { title: 'The Dark Knight', year: 2008, genre: 'Actie', rating: 9.1, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMTMxNTMwODM0NF5BMl5BanBnXkFtZTcwODAyMTk2Mw@@._V1_.jpg' },
  ...
  { title: 'Toy Story 5', year: 2026, genre: 'Komedie', rating: 7.6, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BZTI1YTBiNmEtYWUxZi00YzFkLWIzNjMtMmZjMmY2NzM0ZWMzXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Inception', year: 2010, genre: 'Sci-Fi', rating: 8.8, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMjAxMzY3NjcxNF5BMl5BanBnXkFtZTcwNTI5OTM0Mw@@._V1_.jpg' },
  { title: 'Fight Club', year: 1999, genre: 'Thriller', rating: 8.8, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BOTgyOGQ1NDItNGU3Ny00MjU3LTg2YWEtNmEyYjBiMjI1Y2M5XkEyXkFqcGc@._V1_.jpg' },
  { title: 'Interstellar', year: 2014, genre: 'Sci-Fi', rating: 8.7, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BYzdjMDAxZGItMjI2My00ODA1LTlkNzItOWFjMDU5ZDJlYWY3XkEyXkFqcGc@._V1_.jpg' },
  ...
  { title: 'Independence Day', year: 1996, genre: 'Sci-Fi', rating: 7.0, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BOGMwN2UwZjEtYjFjMi00ZDA1LWJlYTQtMjA1MTYxMzIyNTdiXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Heat', year: 1995, genre: 'Misdaad', rating: 8.3, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMTkxYjU1OTMtYWViZC00ZjAzLWI3MDktZGQ2N2VmMjVjNDRlXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Toy Story', year: 1995, genre: 'Komedie', rating: 8.3, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BZTA3OWVjOWItNjE1NS00NzZiLWE1MjgtZDZhMWI1ZTlkNzYwXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Toy Story 3', year: 2010, genre: 'Komedie', rating: 8.3, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMTgxOTY4Mjc0MF5BMl5BanBnXkFtZTcwNTA4MDQyMw@@._V1_.jpg' },
  ...
  { title: 'Avatar: Fire and Ash', year: 2025, genre: 'Sci-Fi', rating: 7.2, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BZDYxY2I1OGMtN2Y4MS00ZmU1LTgyNDAtODA0MzAyYjI0N2Y2XkEyXkFqcGc@._V1_.jpg' },
  { title: 'Jaws', year: 1975, genre: 'Thriller', rating: 8.1, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BYjViNDQzNmUtYzkxZi00NTk5LTljMmItYjJlZmZkODIxNjU1XkEyXkFqcGc@._V1_.jpg' },
  { title: 'Gone Girl', year: 2014, genre: 'Thriller', rating: 8.1, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMTk0MDQ3MzAzOV5BMl5BanBnXkFtZTgwNzU1NzE3MjE@._V1_.jpg' },
  { title: 'Spider-Man: No Way Home', year: 2021, genre: 'Actie', rating: 8.1, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMmFiZGZjMmEtMTA0Ni00MzA2LTljMTYtZGI2MGJmZWYzZTQ2XkEyXkFqcGc@._V1_.jpg' },
  ...
  { title: 'The Patriot', year: 2000, genre: 'Drama', rating: 7.2, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BYThjZWExNTItYmE5Yi00ZDE3LTk1ZDktMGJiMWUyYTc2YmFkXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Top Gun: Maverick', year: 2022, genre: 'Actie', rating: 8.2, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMDBkZDNjMWEtOTdmMi00NmExLTg5MmMtNTFlYTJlNWY5YTdmXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Dhurandhar: The Revenge', year: 2026, genre: 'Actie', rating: 8.2, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BNzdkNjAxNWMtNWY3My00NTI1LTg2YWQtOGI3MDA0NzdhMjEyXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Superman', year: 2025, genre: 'Sci-Fi', rating: 7.0, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BOGMwZGJiM2EtMzEwZC00YTYzLWIxNzYtMmJmZWNlZjgxZTMwXkEyXkFqcGc@._V1_.jpg' },
  ...
  { title: 'Masters of the Universe', year: 2026, genre: 'Actie', rating: 6.9, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMTJjYTFkM2EtZjBmNy00OTk2LTg0NTAtNzYxYzlmNjhkMzQ5XkEyXkFqcGc@._V1_.jpg' },
  { title: 'Titanic', year: 1997, genre: 'Drama', rating: 8.0, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BYzYyN2FiZmUtYWYzMy00MzViLWJkZTMtOGY1ZjgzNWMwN2YxXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Sinners', year: 2025, genre: 'Thriller', rating: 7.5, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BNjIwZWY4ZDEtMmIxZS00NDA4LTg4ZGMtMzUwZTYyNzgxMzk5XkEyXkFqcGc@._V1_.jpg' },
  { title: 'Weapons', year: 2025, genre: 'Thriller', rating: 7.4, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BNTBhNWJjZWItYzY3NS00M2NkLThmOWYtYTlmNzBmN2UxZWFjXkEyXkFqcGc@._V1_.jpg' },
  ...
  { title: 'The Devil Wears Prada 2', year: 2026, genre: 'Komedie', rating: 6.5, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BZmM3ZDU3ODItZmY5Yi00OTQ2LWE5OTctZTA5NDBhMWJkOGY3XkEyXkFqcGc@._V1_.jpg' },
  { title: 'One Battle After Another', year: 2025, genre: 'Misdaad', rating: 7.6, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMzBkZmQ0NjMtNTZlMy00ZjdlLTg5ODUtYWFlNGM0YzE3MTg0XkEyXkFqcGc@._V1_.jpg' },
  { title: 'Marty Supreme', year: 2026, genre: 'Komedie', rating: 7.6, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BZTRhYjI1MTItMWYwMi00MjY5LWI1OTktMzQwNzA3MWJlN2QyXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Toy Story 4', year: 2019, genre: 'Komedie', rating: 7.6, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMTYzMDM4NzkxOV5BMl5BanBnXkFtZTgwNzM1Mzg2NzM@._V1_.jpg' },
  ...
  { title: 'Michael', year: 2025, genre: 'Drama', rating: 7.5, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BNzllNmRlN2EtMDQyOC00ODJjLTg4OWQtZDNmNGU3YzlkNjc1XkEyXkFqcGc@._V1_.jpg' },
  { title: 'Nuremberg', year: 2025, genre: 'Drama', rating: 7.3, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMWUzODNkYWUtMmMzOC00NzZjLTlkMTctOTkwM2I2ZWI1MTlmXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Remarkably Bright Creatures', year: 2026, genre: 'Komedie', rating: 7.7, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BNzM3OTRlZDktYTk0OS00OTlmLWFhMjctMTZiODU4N2RiYzhhXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Cocktail 2', year: 2026, genre: 'Komedie', rating: 7.7, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMjE4ZDFiMjctZTk0Yy00Mzk0LWIzMzItZmRjZTM0YzBjYmRiXkEyXkFqcGc@._V1_.jpg' },
  ...
  { title: 'Spider-Man: Brand New Day', year: 2026, genre: 'Actie', rating: 8.0, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BOWNjYWM3NWItOGE0ZS00MWRjLThiZWEtYjc4ZmNmMmU5ZTVmXkEyXkFqcGc@._V1_.jpg' },
  { title: 'The Sandlot', year: 1993, genre: 'Komedie', rating: 7.8, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BNTc5YzE5OTAtMmY3YS00ODk4LTgzODItZGEzNmMxMDhhNWUwXkEyXkFqcGc@._V1_.jpg' },
  { title: 'The Invite', year: 2026, genre: 'Komedie', rating: 7.8, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMjI0MzJjMjctNmQzZi00Y2U4LWEwZGItMmE3NDUzNzk1YzY3XkEyXkFqcGc@._V1_.jpg' },
  { title: 'Enola Holmes 2', year: 2022, genre: 'Misdaad', rating: 6.8, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BZjRjZjZhNzUtMDQyMC00OWZmLWIzMjQtZDM2OWRhNzgwOGU2XkEyXkFqcGc@._V1_.jpg' },
  ...
  { title: 'Enola Holmes 3', year: 2026, genre: 'Misdaad', rating: 5.8, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BYzVhNmQ0MzItNjg3Mi00MzM1LWI5MDUtOGZlMTFjNTJjMTM2XkEyXkFqcGc@._V1_.jpg' },
  { title: 'Enola Holmes', year: 2020, genre: 'Misdaad', rating: 6.7, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BMTRlYmI1NTMtYTVkYi00MjJkLWE3ZGItOThkYTdhNzBhMThhXkEyXkFqcGc@._V1_.jpg' },
  { title: 'Mortal Kombat II', year: 2026, genre: 'Actie', rating: 6.4, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BNTg2YWNkN2EtMzc1Ny00ZTBhLWFmYTItMmMyNzhjNjhhNmVhXkEyXkFqcGc@._V1_.jpg' },
  { title: 'The Ministry of Ungentlemanly Warfare', year: 2024, genre: 'Actie', rating: 6.8, type: 'Film', posterUrl: 'https://m.media-amazon.com/images/M/MV5BYmIxODc5ZjMtYzZmZS00OTE5LThkZDktNWNmODNiZjFhMDgyXkEyXkFqcGc@._V1_.jpg' },
];
